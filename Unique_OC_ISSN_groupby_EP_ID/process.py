...
def process_meta_csv(chunk, erih_plus_df):
    ...
    #merged_data = merged_data[['id', 'issn', 'Journal ID']].rename(columns={'id': 'OC_OMID', 'issn': 'OC_ISSN', 'Journal ID': 'EP_ID'})
    ...
    # Add the 'Publication Count' column
    #merged_data['Publication Count'] = merged_data.groupby('EP_ID')['EP_ID'].transform('count')
